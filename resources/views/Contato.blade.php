      ...
      <div class="bg-white rounded p-8 dark:bg-slate-900">
        ...
        <div class="grid lg:grid-cols-2 items-start gap-12">
          ...
          <div class="grid sm:grid-cols-2  gap-12">
            <div class="flex items-start bg-transparent">
              <div class="px-3 py-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-blue-500" viewBox="0 0 512 512">
            ...
            <div class="flex items-start bg-transparent">
              <div class="px-3 py-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-blue-500" viewBox="0 0 473.806 473.806">
            ...
            <div class="flex items-start bg-transparent">
              <div class="px-3 py-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-blue-500" viewBox="0 0 32 32">
            ...
            <div class="flex items-start bg-transparent">
              <div class="px-3 py-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-blue-500" viewBox="0 0 100 100">
