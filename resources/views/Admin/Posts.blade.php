...
<div class="flex w-screen h-screen text-gray-700">
    ...
    <!-- ÍCONE QUADRADO -->
            <div class="flex flex-col items-center w-16 pb-4 overflow-auto border-r border-gray-300">
                ...
                <!-- ÍCONE HOME -->
                <a class="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 rounded hover:bg-gray-300" href="/admin">
                ...
                <a class="flex items-center justify-center flex-shrink-0 w-10 h-10 mt-4 rounded bg-gray-300" href="#">
                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
