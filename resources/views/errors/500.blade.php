...
<div class="w-full h-screen flex items-center justify-center">
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-500 flex flex-col items-center justify-center px-6 md:px-10 lg:px-16 py-10 rounded-lg shadow-2xl transition-transform transform hover:scale-105">
