    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div class="lg:pr-8 lg:pt-4">
        <div class="lg:max-w-lg">
          ...
          <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 font-normal dark:text-gray-300 lg:max-w-none">
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-600 dark:text-gray-100">
            ...
            <div class="relative pl-9">
              <dt class="inline font-semibold dark:text-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="absolute left-1 top-1 h-5 w-5 text-blue-500">
